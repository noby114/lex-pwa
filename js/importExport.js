...
[
  {
    "word": "見出し語",
    "senses": [
      { "pos": "品詞（名詞/動詞/形容詞/副詞/前置詞/接続詞/熟語/その他のいずれか）", "meaningJa": "日本語の意味", "phonetic": "品詞ごとに発音（アクセント位置など）が異なる場合は必須。変わらない場合は省略可" }
    ],
    "examples": [
...
- record（名詞: RÉ-cord /ˈrekərd/、動詞: re-CÓRD /rɪˈkɔːrd/）のように、名詞と動詞で強勢（アクセント）の位置や母音が変わる単語（他に例: present, permit, produce, project, contract, object など）があります。このような単語では、品詞ごとに正しいIPA発音記号を必ずそれぞれのsenseの"phonetic"に入れてください。同じ発音のまま品詞だけ変わる単語では"phonetic"は省略して構いません。
